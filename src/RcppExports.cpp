...
// coreDualLoopParResp
void coreDualLoopParResp(const MapMat cp_X, const MapMat cp_Y_X, MapArr2D gam_vb, const MapArr2D log_Phi_theta_plus_zeta, const MapArr2D log_1_min_Phi_theta_plus_zeta, const double log_sig2_inv_vb, const MapArr1D log_tau_vb, MapMat m1_beta, MapMat cp_betaX_X, MapArr2D mu_beta_vb, const MapArr1D sig2_beta_vb, const MapArr1D tau_vb, const Eigen::VectorXi shuffled_ind, const Eigen::VectorXi sample_q, const double c);
RcppExport SEXP _atlasqtl_coreDualLoopParResp(SEXP cp_XSEXP, SEXP cp_Y_XSEXP, SEXP gam_vbSEXP, SEXP log_Phi_theta_plus_zetaSEXP, SEXP log_1_min_Phi_theta_plus_zetaSEXP, SEXP log_sig2_inv_vbSEXP, SEXP log_tau_vbSEXP, SEXP m1_betaSEXP, SEXP cp_betaX_XSEXP, SEXP mu_beta_vbSEXP, SEXP sig2_beta_vbSEXP, SEXP tau_vbSEXP, SEXP shuffled_indSEXP, SEXP sample_qSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MapMat >::type cp_X(cp_XSEXP);
    Rcpp::traits::input_parameter< const MapMat >::type cp_Y_X(cp_Y_XSEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXi >::type sample_q(sample_qSEXP);
    Rcpp::traits::input_parameter< const double >::type c(cSEXP);
    coreDualLoopParResp(cp_X, cp_Y_X, gam_vb, log_Phi_theta_plus_zeta, log_1_min_Phi_theta_plus_zeta, log_sig2_inv_vb, log_tau_vb, m1_beta, cp_betaX_X, mu_beta_vb, sig2_beta_vb, tau_vb, shuffled_ind, sample_q, c);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_atlasqtl_coreDualLoopParResp", (DL_FUNC) &_atlasqtl_coreDualLoopParResp, 15},
    {NULL, NULL, 0}
};
