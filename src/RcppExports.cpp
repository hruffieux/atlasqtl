...
BEGIN_RCPP
    ...
    coreDualLoop(cp_X, cp_Y_X, gam_vb, log_Phi_theta_plus_zeta, log_1_min_Phi_theta_plus_zeta, log_sig2_inv_vb, log_tau_vb, m1_beta, cp_X_Xbeta, mu_beta_vb, sig2_beta_vb, tau_vb, shuffled_ind, sample_q, c);
    return R_NilValue;
END_RCPP
}
// coreDualMisLoop
void coreDualMisLoop(const MapMat cp_X, const MapMat sq_X, const MapMat cp_Y_X, MapArr2D gam_vb, const MapArr2D log_Phi_theta_plus_zeta, const MapArr2D log_1_min_Phi_theta_plus_zeta, const double log_sig2_inv_vb, const MapArr1D log_tau_vb, MapMat m1_beta, MapMat cp_X_Xbeta, MapArr2D mu_beta_vb, const MapArr2D sig2_beta_vb, const MapArr1D tau_vb, const Eigen::VectorXi shuffled_ind, const Eigen::VectorXi sample_q, const MapMat X, const Eigen::VectorXi k_index_vec, const List& list_ind_mis, const double c);
RcppExport SEXP _atlasqtl_coreDualMisLoop(SEXP cp_XSEXP, SEXP sq_XSEXP, SEXP cp_Y_XSEXP, SEXP gam_vbSEXP, SEXP log_Phi_theta_plus_zetaSEXP, SEXP log_1_min_Phi_theta_plus_zetaSEXP, SEXP log_sig2_inv_vbSEXP, SEXP log_tau_vbSEXP, SEXP m1_betaSEXP, SEXP cp_X_XbetaSEXP, SEXP mu_beta_vbSEXP, SEXP sig2_beta_vbSEXP, SEXP tau_vbSEXP, SEXP shuffled_indSEXP, SEXP sample_qSEXP, SEXP XSEXP, SEXP k_index_vecSEXP, SEXP list_ind_misSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MapMat >::type cp_X(cp_XSEXP);
    Rcpp::traits::input_parameter< const MapMat >::type sq_X(sq_XSEXP);
    Rcpp::traits::input_parameter< const MapMat >::type cp_Y_X(cp_Y_XSEXP);
    Rcpp::traits::input_parameter< MapArr2D >::type gam_vb(gam_vbSEXP);
    Rcpp::traits::input_parameter< const MapArr2D >::type log_Phi_theta_plus_zeta(log_Phi_theta_plus_zetaSEXP);
    Rcpp::traits::input_parameter< const MapArr2D >::type log_1_min_Phi_theta_plus_zeta(log_1_min_Phi_theta_plus_zetaSEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXi >::type k_index_vec(k_index_vecSEXP);
    Rcpp::traits::input_parameter< const List& >::type list_ind_mis(list_ind_misSEXP);
    Rcpp::traits::input_parameter< const double >::type c(cSEXP);
    coreDualMisLoop(cp_X, sq_X, cp_Y_X, gam_vb, log_Phi_theta_plus_zeta, log_1_min_Phi_theta_plus_zeta, log_sig2_inv_vb, log_tau_vb, m1_beta, cp_X_Xbeta, mu_beta_vb, sig2_beta_vb, tau_vb, shuffled_ind, sample_q, X, k_index_vec, list_ind_mis, c);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_atlasqtl_coreDualMisLoop", (DL_FUNC) &_atlasqtl_coreDualMisLoop, 19},
    {NULL, NULL, 0}
};
