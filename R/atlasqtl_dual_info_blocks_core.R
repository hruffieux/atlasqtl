...
# link, no fixed covariates. See help of `atlasqtl` function for details.
#
atlasqtl_dual_info_blocks_core_ <- function(Y, X, list_V, vec_fac_bl, list_hyper, gam_vb, mu_beta_vb,
